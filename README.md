...
# blueprint-azure-iot-hub-tutorial
...
![Particle and Azure IoT Hub architecture diagram](images/particle+iot-hub-architecture.png)
...
![Create an IoT Hub](images/create-iot-hub.png)
...
![Configure an IoT Hub](images/configure-iot-hub.png)
...
![Create shared IoT Hub policy](images/create-shared-policy.png)
...
![Access shared IoT Hub policy info](images/access-shared-policy-info.png)
...
![](images/configure-integration.png)
...
![Particle + Azure IoT Hub connection string](images/connection-string.png)
